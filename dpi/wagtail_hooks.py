...
class DpiLicensesButtonHelper(ButtonHelper):
    ...
    def json_button(self, obj):
        ...
        # obj_id = obj.id
        button_url = reverse("dpi_license_download", args=[obj.id])
...
class DpiLicensesPermissionHelper(PermissionHelper):
    """
    ...
    def user_can_create(self, user):
        # if DpiLicenses.objects.count() > 0:
        #    return False
...
class DpiLicensesAdmin(ModelAdmin):
    model = DpiLicenses
    # button_helper_class = DpiLicensesButtonHelper  # Uncomment this to enable button
    # inspect_view_enabled = True
    menu_label = "DPI License"  # ditch this to use verbose_name_plural from model
    menu_icon = "crosshairs"  # change as required
    ...
    permission_helper_class = DpiLicensesPermissionHelper
...
modeladmin_register(DpiLicensesAdmin)
