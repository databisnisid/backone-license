    ...
    def clean(self):
        ...
        if self.valid_until <= current_time:
            raise ValidationError(
                {"valid_until": _("License Validity must be in the future from now")}
            )
